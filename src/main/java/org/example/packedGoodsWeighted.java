...
public class packedGoodsWeighted
        //Класс «Упакованный весовой товар» содержит
        // упаковку и некоторое количество весового товара (в кг).
{
    ...
    public String toString() {
        return " Наименование товара:'" + default_goodsWeighted.getName_goods() + '\'' + '\n'+
                ...
                " Масса нетто:'" +  default_goodsWeighted.getWeight() + '\'' + '\n'+
                " Масса брутто:'" + default_packagingOfGoods.getMass_pack()+default_goodsWeighted.getWeight() + '\'' + '\n'+
